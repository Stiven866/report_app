...
class _ImageScreenState extends State<ImageScreen> {
  ...
  Widget _buidScaffold(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Enviar un reporte de video o imagen"),
        centerTitle: true,
  ...
  _sendImage(File fileImage) async {
    ...
    Reference ref =
        storage.ref().child("images/${user!.uid}/" + DateTime.now().toString());
        ...
        .post(url,
            ...
            body: json.encode({
              ...
              "template_params": {
                'user_name': "ricardo",
                'to_email':
                    "ricardo.tangarife@udea.edu.co, fabian.duque@udea.edu.co",
